...
export default function Card({
    ...
    return (
        ...
        >
            ...
            />
            <div className="absolute top-0 left-0 w-full h-full rounded-lg bg-transparent transition-all border-2 group-hover:border-[#3D81F7] border-transparent duration-300 z-10 cursor-pointer" />
            <div 
